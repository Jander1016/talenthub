...
const SigninPage = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[110px]">
            ...
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[700px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                ...
                <p className="mb-11 text-center text-base font-medium text-body-color">
                  Por favor, rellena el siguiente formulario que será procesado por nuestro staff tan pronto sea posible.
                </p>
...
<h3 className="mb-4 font-semibold text-gray-900 dark:text-white">Stacks</h3>
