...
const CardDetails = () => {
    ...
    const {data, error} = useFetch('http://localhost:3001/talents?talent_id='+ pathname[2]);
    console.log(data)
    // const [data, setData] = useState<any>(null)

    // const dataTalents = async () => {
    //     const listData = await fetch('https://localhost:3001/talents/'+ pathname[2])
    //     const talents = await listData.json()
    //     console.log(talents)
    //     setData(talents)
    // }

    // useEffect(() => {dataTalents() }, [])
